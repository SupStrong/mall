    ...
    Video.prototype = {
        ...
        _createPanel: function _createPanel() {
            ...
            }, // first tab end
            {
                ...
                title: '插入视频',
                // 模板
                tpl: '<div><input id="' + textValId + '" type="text" class="block" placeholder="请输入在线链接"/><div class="w-e-button-container"><button id="' + btnId + '" class="right">\u63D2\u5165</button></div></div>',
                // 事件绑定
                events: [{
                    selector: '#' + btnId,
                    type: 'click',
        ...
        _insert: function _insert(val) {
            var editor = this.editor
            editor.cmd.do('insertHTML', `<iframe height=498 width=510 src='${val}' frameborder=0 'allowfullscreen'></iframe>` + '<p><br></p>')
        }
    }
