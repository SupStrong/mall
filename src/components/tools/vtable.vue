<template>
  <div class="table-container">
    <el-card :shadow="shadow" :body-style="bodyStyle" :style="{border: bodyStyle.padding === '0px' ? 'none' : '1px solid #EBEEF5'}">
    <el-table
      ref="table"
      :data="paginationData"
      :border="border"
      ...
      >
        ...
        <template slot-scope="scope">
          ...
          <div class="action-con" v-else-if="column.type === 'action'">
            ...
            <!-- <el-popover placement="right" width="200" trigger="hover" v-if="getScreenWidth < 1400 || column.buttonInfos.length > 3">
              <el-button
          ...
          <div v-else-if="column.type === 'func'">
            <!-- {{column.func()}} -->
            <p v-html="column.func(scope.row, this)"></p>
          </div>
...
export default {
  ...
  computed: {
    ...mapGetters(['authButton', 'getScreenWidth']),
    paginationData() {
      let tempData = []
      if (this.isBackPage) {
