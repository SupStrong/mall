...
export default {
  ...
  methods: {
    // 添加类目
    setThree(obj) {
      this.one = obj.categoryId1Name;
      this.two = obj.categoryId2Name;
      this.three = obj.categoryId3Name;
    },
    clearSearch() {
      this.one = null;
      this.two = null;
